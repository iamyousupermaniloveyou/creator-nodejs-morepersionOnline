cc.Class({
    ...
    onLoad: function () {
        ...
        // cc.director.getCollisionManager().debugDrawFlags = Bits.e_jointBit | Bits.e_shapeBit;
    },

    // called every frame, uncomment this function to activate update callback
    start: function (dt) {
        // this._control = cc.instantiate(this.control_mian)
        // if(this._control){
        //     this.node.addChild(this._control)
        // }
        // this._control = cc.getChildByName("control_main")
    },
});
